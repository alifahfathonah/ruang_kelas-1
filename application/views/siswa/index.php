        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header">
             <button type="button" data-toggle="modal" data-target="#modal-default" class="btn btn-primary btn-sm">Tambah Siswa</button>
            </div>
                    ...
                    <tr>
                      ...
                      <div style="width: 130px;">
                        <td>
                          ...
                          <button type="button" onclick="del('<?php echo base_url('siswa/delete/').$key['user_id'] ?>')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button>
                        </td>
                      </div>
                    </tr>
                    ...
                    <div class="modal fade" id="modal-edit<?php echo $key['user_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="modal-default" aria-hidden="true">
                      <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
                        <div class="modal-content">
                          ...
                          <form method="post" action="<?php echo base_url('siswa/edit/').$key['user_id']; ?>">

                            <div class="modal-header">
                              <h6 class="modal-title" id="modal-title-default">Edit Siswa</h6>
                            ...
                            <div class="modal-body">
                              ...
                              <div class="row">
                                ...
                                <div class="row">
                                  <div class="col-md-12">
                                    <div class="form-group">
                                      <label class="col-form-label form-control-label">NISN</label>
                                      <input readonly="" class="form-control" required="" name="nis" type="text" value="<?php echo $key['user_email'] ?>" id="example-text-input">
                                    </div>
                                  </div>
                                </div>
                                <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label class="col-form-label form-control-label">NISN</label>
                        <input class="form-control" required="" name="nis" type="text" value="" id="example-text-input">
                      </div>
                    </div>
                  </div>
                  <div class="row">
