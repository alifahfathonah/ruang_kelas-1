              ...
              <form class="form-row" action="<?php echo base_url('uraian/save') ?>" method="post" enctype="multipart/form-data">
                 ...
                 <div class="form-group col-md-12">
                  <select class="form-control" name="uraian_mapel" required="">
                    ...
                    <option hidden="" value="<?php echo $mapel_id ?>"><?php echo $mapel_val; ?></option>
                 ...
                 <?php for ($i = 1; $i < 6 ; $i++): ?>
                   ...
                   <div class="form-group col-11 row">
                     <textarea required="" name="soal<?php echo $i; ?>" class="form-control" style="height: 160px;"><?php echo $data['soal'.$i] ?></textarea>
                   </div>
                 <?php endfor ?>
